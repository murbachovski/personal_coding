# 🚀 프로젝트 설명
```
학생 데이터셋을 활용한 GPA 예측 신경망 모델로, MinMaxScaler를 적용한 정규화 모델
```
...
# 📁 Kaggle
[Students performance analysis and GPA prediction](https://www.kaggle.com/code/nairec/students-performance-analysis-and-gpa-prediction/input)
